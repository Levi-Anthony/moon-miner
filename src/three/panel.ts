...
export function createPanel(ctx: PanelCtx): void {
  ...
  addRow({ label: 'Off-road / laying speed', min: 5, max: 1500, step: 1, fmt: int, hint: 'Speed while laying fresh ribbon at the frontier — the strategic pace. Tune for decisions, not reflexes.', get: tget('fabricatingSpeed'), set: tset('fabricatingSpeed') });
